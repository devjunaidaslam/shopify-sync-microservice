...
namespace PartFinder_DataAccess.Context
{
    public class PartFinderDbContext : IdentityDbContext<AspNetUser>
    {
        public PartFinderDbContext()
        {
            
        }
        public PartFinderDbContext(DbContextOptions options) : base(options)
        {
        }
