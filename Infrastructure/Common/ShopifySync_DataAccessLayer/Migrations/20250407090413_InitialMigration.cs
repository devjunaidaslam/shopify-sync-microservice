        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerificationOTP = table.Column<string>(type: "text", nullable: true),
                    EmailVerificationOTPExpiration = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UserProfileImage = table.Column<string>(type: "varchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserLoginLogId = table.Column<string>(type: "varchar(50)", nullable: true),
                    Stacktrace = table.Column<string>(type: "text", nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    Message = table.Column<string>(type: "text", nullable: false),
                    Request = table.Column<string>(type: "text", nullable: false),
                    LogError = table.Column<string>(type: "text", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
